...
def ArgsGeneralWrapper(f):
    ...
    """
    def decorated(cookies, max_length, llm_model, txt, txt2, top_p, temperature, chatbot, history, system_prompt, plugin_advanced_arg, omniverse_switch,record_audio,asr,*args):
        txt_passon = txt
